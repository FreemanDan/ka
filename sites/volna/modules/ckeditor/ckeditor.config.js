...
CKEDITOR.editorConfig = function (config) {
    config.isndentClasses = ['rteindent1', 'rteindent2', 'rteindent3', 'rteindent4'];
    ...
    config.extraPlugins = '';
    config.line_height = "12px;24px;36px;48px;60px;72px;84px;96px;108px;120px;132px;144px";
     ...
     */
    config.contentsCss = ['/sites/all/libraries/fontawesome/css/font-awesome.css',
        '/sites/volna/themes/lanpag/css/style.css',
        '/sites/volna/themes/lanpag/css/custom/custom.css'];
    config.extraCss = '';
