...
//форма добавления ссылки. шаг 2
//поздравление о добавленной ссылке.
//все данные передаются сюда в $post_item_data


$form_db=array();
$form_db['HEADER']='Ссылка принята в каталог';
$form_db['MESSAGE']='Спасибо. Ваша ссылка принята в наш каталог. ';
