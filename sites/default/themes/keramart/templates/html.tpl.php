...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <?php print $styles; ?>
  <?php //Добавляю путь к шприфту cuprum  ?>
<link href='http://fonts.googleapis.com/css?family=Roboto:300,400&subset=latin,cyrillic' rel='stylesheet' type='text/css'>
  <?php print $scripts; ?>
  ...
  <?php elseif ($add_html5_shim): ?>
    ...
    <![endif]-->
  <?php endif; ?>
  <script type="text/javascript">(window.Image ? (new Image()) : document.createElement('img')).src = location.protocol + '//vk.com/rtrg?r=KMOFH/PIBbfQ4g*8wE4FijZsPnwkxwwW1TRPSRHeTpdMgm4oG8yjigltAy99T4Xfhuc*HIXcm4s6fOwvtCO8gHa0wGUXOcfDZdPo7Kbft*OUYuknhRxMg*Sa2yj3D*PPjxe6T9NQsyJf*L1gJdTgNJGZ2GCbw1rxPMo9KeK6TDk-&pixel_id=1000022614';</script>
  <meta name="yandex-verification" content="8111072a3c2e3734" />
  </head>
